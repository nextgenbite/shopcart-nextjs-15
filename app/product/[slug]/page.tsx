...
import { Product, fetchProductBySlug } from "@/types/active_ecommerce_json";
import {
  BadgeQuestionMark,
  CornerDownLeft,
  GitCompare,
...
const ProductDetailPage = async ({ params }: { params: { slug: string } }) => {
  ...
  const product: Product = await fetchProductBySlug(slug);

  if (!product) return notFound();
  console.log("Product in ProductDetailPage:", product);
  return (
